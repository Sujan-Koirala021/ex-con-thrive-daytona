...
const NameGenerator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    query += ` Return the name in the form of word with synonym word as meaning in bracket and then comma. Note that no commas in the meaning. format: word1(meaning1), word2(meaning2)`;
